...
- Create Angular project with ng: `ng new gigatelsolutionswebsite.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`gigatelsolutionswebsite.client.esproj`).
